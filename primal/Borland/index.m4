divert(-1)
define(_TITLE, `GAMMA Builds Using Borland BC++')
define(_PRIMALDIR, `..')
...
define(_TOPNAME, Borland BC++<BR>Builds & Targets)
define(_CREATION,    `September 23 2002')
define(_CGIDOCNAME,  `borland')
define(_KEYWORDS,    ``
  <META name="keywords" content="NMR, ESR, EMR, MRI, FID, resonance, science, education, simulation">'')
define(_DESCRIPTION, `
  <META name="description" content="GAMMA Builds Using The Borland BC++.">')
define(_JAVASCRIPT, `')
define(_SUBDIR, borland)
      ...
      <TABLE border=0 valign="top">
        <TR>
          <TD valign=top>
            ...
            GAMMA libraries (static, DLL, PyGAMMA DLL) using the <A HREF="_BORLAND">Borland</A>
            free C++ compiler. You MUST have the <A HREF="_BORLAND">Borland</A> C++ compiler
            functioning on your computer system (PC) in command line mode before these files
            will be of any direct use to you. Furthermore`,' to build and use 
            <A HREF="_DOCDIR/pygamma/index.html">PyGAMMA</A> 
            you must have both <A HREF="_PYTHON">Python</A> 
            and <A HREF="_BOOST_PYTHON">Boost.Python</A> on the system. The Python must be the
            Windows version and Boost.Python should have been built with the Borland compiler.
            More information of <A HREF = "_DOCDIR/pygamma/python/borland/index.html">Setting Up Python</A>
            and <A HREF = "_DOCDIR/pygamma/boost/borland/index.html">Setting Up Boost.Python</A> for Borland
            ...
            either because it has a bug`,' or it is not supported on a particular OS/compiler
            combination. This makefile is a vastly simplified version of the main GAMMA makefile.
            If it does not work`,' at least it can be used as a guide to build a working Makefile.
            At the time this page was written`,' the current version of the free Borland compiler
            is 5.5 and it is tested on Windows 2000.  Note that due the the nature of the Borland
            <EM>make</EM> program`,' this file is significantly different then Makefiles that use
            the GNU make program.<BR>&nbsp;

            <CENTER><FONT SIZE="+2">Quick Build Instructions</FONT>
                    <BR>
                    <FONT SIZE="+1">(Assumes Working Borland C++ & Proper Environment Settings)</FONT><BR>&nbsp;
            </CENTER>
          </TD>
        </TR>
        <TR>
          <TD>
            ...
            <TABLE align="CENTER">
              <TR><TD><IMG SRC="../figs/win.gif"></TD><TD>1.`)' Open a DOS shell: Provided with Windows</TD></TR>
              <TR><TD><IMG SRC="../figs/dos.gif"></TD><TD>2.`)' Change into this directory: <EM>cd GAMMAVER/primal/Borland</EM></TD></TR>
              <TR><TD><IMG SRC="../figs/dos.gif"></TD><TD>3.`)' Run make to clean previous files: <EM>make clean</EM></TD></TR>
            <TR><TD><IMG SRC="../figs/dos.gif"></TD><TD>4.`)' Run make to build static lib. & DLLs: <EM>make</EM></TD></TR>
            <TR><TD valign="top"><IMG SRC="../figs/dos.gif"></TD><TD>5.`)' Run <EM>make install</EM> to use this build as your GAMMA<BR>&nbsp;</TD></TR>
            <TR><TH colspan=2>Optional Final Cleanup`,' Demos`,' & Testing<TH></TR>
            <TR><TD><IMG SRC="../figs/dos.gif"></TD><TD>6.`)' Run make to clean: <EM>make clean</EM></TD></TR>
            <TR><TD><IMG SRC="../figs/dos.gif"></TD><TD>7.`)' Run make to build demo program <EM>make demo</EM></TD></TR>
            <TR><TD><IMG SRC="../figs/dos.gif"></TD><TD>8.`)' Run make to build test program <EM>make test</EM></TD></TR>
            <TR><TD valign="top"><IMG SRC="../figs/dos.gif"></TD><TD>9.`)' Run make to clean: <EM>make clean</EM><BR>&nbsp;</TD></TR>
            </TABLE>
            </TD></TR></TABLE><BR>&nbsp;
          </TD>
        </TR>
        ...
        <TR>
          <TD>
            ...
            directory hierarchy`,' <EM>../../i686-pc-borland</EM>. As the GAMMA code files (*.cc) are 
          ...
          <TD>
            <TABLE align=center>
              ...
              <TR>
                ...
                <TH>&nbsp;</TH>
                <TH><FONT SIZE="-1">(GV/i686-pc-borland)</FONT></TH>
                <TH>&nbsp;</TH>
                <TH><FONT SIZE="-1">(GV/i686-pc-borland)</FONT></TH>
              </TR>
              <TR>
        ...
        <TR>
          <TD>
            ...
            <P> 
            <STRONG><FONT SIZE="-1">
                    Note that if the Borland generated GAMMA DLL is present in <EM>../../i686-pc-borland</EM>
            ...
            are relocatable`,' they do rely on the associated GAMMA library as well as the Borland DLL.
            Hopefully you have the Borland DLL on your system or you should not be using this Makefile.
            As for the GAMMA libraries`,' during program compilation using the GAMMA script it is 
            specified that these reside in <EM>../../i686-pc-borland</EM> so the executable inherently 
            ...
            your system depends upon where you installed Borland. Note that the Makefile command
        ...
        <TR>
          <TD>
            ...
            specific in that it <STRONG>assumes the user is working with Borland</STRONG>. Consequently it
            keeps all binaries in a Borland specific directory. 
            <P>
            ...
            <P>
            The Makefile contains the variable BINDIR which will be set to ../../i686-pc-borland.
            ...
            where the GAMMA headers are on your system (../../src)`,' where the GAMMA Borland binaries are
            (../../i686-pc-borland)`,' and available for all users on the system.  When you invoke 
            ...
            library`,' <EM>libgamma.a</EM>. This is built in the directory (../../i686-pc-borland) and will
            stay there even after <EM>make install</EM>. The <EM>gamma</EM> script can find it because it
            will know that directory ../../i686-pc-borland contains GAMMA Borland binaries. The second and
            ...
            and will remain in ../../i686-pc-borland. But the former must be placed into a directory known
            ...
            for the Borland build and moved into a location known by the system.
            <P>
