divert(-1)
define(_TITLE, `GAMMA Builds Using Linux')
define(_PRIMALDIR, `..')
...
define(_TOPNAME, Linux<BR>Builds & Targets)
define(_CREATION,    `September 23 2002')
define(_CGIDOCNAME,  `linux')
define(_KEYWORDS,    ``
  <META name="keywords" content="NMR, ESR, EMR, MRI, FID, resonance, science, education, simulation">'')
define(_DESCRIPTION, `
  <META name="description" content="GAMMA Builds Using Linux.">')
define(_JAVASCRIPT, `')
define(_SUBDIR, linux)
      ...
      <TABLE border=0 valign="top">
        <TR>
          <TD valign=top>
            ...
            GAMMA libraries (static, shared, PyGAMMA shared) using the <A HREF="_LINUX">Linux</A>
            operating system. You MUST have <A HREF="_LINUX">Linux</A> running on your
            computer system (PC) before these files will be of any direct use to you. 
            <P>
            ...
            <A HREF = "_DOCDIR/pygamma/python/linux/index.html">Setting Up Python</A> and
            <A HREF = "_DOCDIR/pygamma/boost/linux/index.html">Setting Up Boost.Python</A> for 
            Linux is available in local GAMMA documentation if needed. 
            ...
            be used as a guide to build a working Makefile. The Makefile was tested with Red Hat
            Linux. At the time this page was written`,' the current version of RH is 8.0 and it
            contains both GCC 3.2 20020903 (Red Hat Linux 8.0 3.2-7).  Builds of GAMMA using this Linux
        ...
        <TR>
          <TD>
            ...
            <TABLE align="CENTER">
              <TR><TD><IMG SRC="../figs/lin.gif"></TD><TD>1.`)' Open a bash shell: Provided with Linux</TD></TR>
              <TR><TD><IMG SRC="../figs/lin.gif"></TD><TD>2.`)' Change into this directory: <EM>cd GAMMAVER/primal/Linux</EM></TD></TR>
              <TR><TD><IMG SRC="../figs/lin.gif"></TD><TD>3.`)' Run make to clean previous files: <EM>make clean</EM></TD></TR>
            <TR><TD><IMG SRC="../figs/lin.gif"></TD><TD>4.`)' Run make to build static & shared libraries: <EM>make</EM></TD></TR>
            <TR><TD><IMG SRC="../figs/lin.gif"></TD><TD>5.`)' Run make to install: <EM>make install</EM></TD></TR>
            <TR><TH colspan=2>Optional Final Cleanup`,' Demos`,' & Testing<TH></TR>
            <TR><TD><IMG SRC="../figs/lin.gif"></TD><TD>6.`)' Run make to clean: <EM>make clean</EM></TD></TR>
            <TR><TD><IMG SRC="../figs/lin.gif"></TD><TD>7.`)' Run make to build demo program <EM>make demo</EM></TD></TR>
            <TR><TD><IMG SRC="../figs/lin.gif"></TD><TD>8.`)' Run make to build test program <EM>make test</EM></TD></TR>
            <TR><TD valign="top"><IMG SRC="../figs/lin.gif"></TD><TD>9.`)' Run make to clean: <EM>make clean</EM><BR>&nbsp;</TD></TR>
            </TABLE>
            </TD></TR></TABLE>
          </TD>
        </TR>
        ...
        <TR>
          <TD>
            ...
            These libraries will automatically placed into a Linux binaries directory within the GAMMA
            directory hierarchy`,' <EM>../../i686-pc-linux-gnu</EM>. As the GAMMA code files (*.cc) are 
            compiled into object files (*.o or *.soo or *.po) they will also be placed into this same binaries
            directory. The Linux binaries directory is the same one which the main GAMMA Makefile
        ...
        <TR>
          <TD>
            ...
            <EM>/gamma/gamma-4.1.0/i686-pc-linux-gnu</EM>. Alternatively`,'
            if there is already a <EM>LD_LIBRARY_PATH</EM> variable set`,' you should add the GAMMA Linux
            ...
            <P> 
            <STRONG><FONT SIZE="-1">
              Note that if the Linux generated GAMMA shared library is present in <EM>../../i686-pc-linux-gnu</EM>
        ...
        <TR>
          <TD>
            ...
            but it demands that
            <OL>
              <LI>Python for Linux is installed on the system.
              <LI>Boost.Python for Linux is installed on the system.
        ...
        <TR>
          <TD>
            <P>
            You can remove any shared library related files from <EM>../../i686-pc-linux-gnu</EM> by using the target
        ...
        <TR>
          <TD>
            ...
            <HR>
            <P>
            <CENTER><FONT SIZE="+2">About Shared Libraries On Linux</FONT></CENTER>
          </TD>
        </TR>
        <TR>
          <TD>
            ...
            <H3>Compiling</H3>
            <P>
            Under Linux`,' the command for creating shared libraries is:<P>
