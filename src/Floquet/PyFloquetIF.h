...
**                              G A M M A				**
**									**
**      PyGAMMA Floquet Module Interface             Interface		**
**									**
**      Copyright (c) 2002						**
**      Scott Smith							**
...
** when the GAMMA Floquet module is built into a Python module without	**
...
#include <Floquet/FloquetIF.h>			// All of Floquet module
...
// ____________________________________________________________________________
// ____________________________________________________________________________
// I                      GAMMA Floquet Module Exports
// ____________________________________________________________________________
// ____________________________________________________________________________

  PyFloqOp();					// Floquet operators
  PyFloq2Op();					// Floquet operators 2 rotations
  PyFloqAcq();					// Floquet acquisitions
  }
