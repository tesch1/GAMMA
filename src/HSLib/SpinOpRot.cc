...
void PySpinOpRot()
  {
  def("Rx", (spin_op (*)(const spin_sys&, int, double)) &Rx);
  def("Ry", (spin_op (*)(const spin_sys&, int, double)) &Ry);
  def("Rz", (spin_op (*)(const spin_sys&, int, double)) &Rz);

  def("Rx", (spin_op (*)(const spin_sys&, const std::string&, double)) &Rx);
  def("Ry", (spin_op (*)(const spin_sys&, const std::string&, double)) &Ry);
  def("Rz", (spin_op (*)(const spin_sys&, const std::string&, double)) &Rz);

//  def("Rx", (spin_op (*)(const spin_sys&, const flagvec&, double)) &Rx);
//  def("Ry", (spin_op (*)(const spin_sys&, const flagvec&, double)) &Ry);
//  def("Rz", (spin_op (*)(const spin_sys&, const flagvec&, double)) &Rz);

  def("Rx", (spin_op (*)(const spin_sys&, double)) &Rx);
  def("Ry", (spin_op (*)(const spin_sys&, double)) &Ry);
  def("Rz", (spin_op (*)(const spin_sys&, double)) &Rz);

  def("Rx_sp",      Rx_sp);
  def("Ry_sp",      Ry_sp);
  def("Rz_sp",      Rz_sp);

  def("Raxis", (spin_op (*)(const spin_sys&, int,                double, char)) &Raxis);
  def("Raxis", (spin_op (*)(const spin_sys&, const std::string&, double, char)) &Raxis);
  def("Raxis", (spin_op (*)(const spin_sys&,                     double, char)) &Raxis);
//def("Raxis", (spin_op (*)(const spin_sys&, const flagvec&,     double, char)) &Raxis);
  def("Raxis", (spin_op (*)(const spin_sys&,                     double, char)) &Raxis);

  def("Rxy", (spin_op (*)(const spin_sys&, int, double, double)) &Rxy);
  def("Ryz", (spin_op (*)(const spin_sys&, int, double, double)) &Ryz);
  def("Rzx", (spin_op (*)(const spin_sys&, int, double, double)) &Rzx);

  def("Rxy", (spin_op (*)(const spin_sys&, const std::string&, double, double)) &Rxy);
  def("Rzx", (spin_op (*)(const spin_sys&, const std::string&, double, double)) &Ryz);
  def("Ryz", (spin_op (*)(const spin_sys&, const std::string&, double, double)) &Rzx);

  def("Rxy", (spin_op (*)(const spin_sys&, double, double)) &Rxy);
  def("Rzx", (spin_op (*)(const spin_sys&, double, double)) &Rzx);
  def("Ryz", (spin_op (*)(const spin_sys&, double, double)) &Ryz);

//def("Rxy", (spin_op (*)(const spin_sys&, const flagvec&, double, double)) &Rxy);
//def("Rzx", (spin_op (*)(const spin_sys&, const flagvec&, double, double)) &Ryz);
//def("Ryz", (spin_op (*)(const spin_sys&, const flagvec&, double, double)) &Rzx);

  def("Rxy_sp", Rxy_sp);
  def("Rzx_sp", Rzx_sp);
  def("Ryz_sp", Ryz_sp);

  def("Rplane",    (spin_op (*)(const spin_sys&, int,                double, double, char)) &Rplane);
  def("Rplane",    (spin_op (*)(const spin_sys&, const std::string&, double, double, char)) &Rplane);
  def("Rplane",    (spin_op (*)(const spin_sys&,                     double, double, char)) &Rplane);
//def("Rplane",    (spin_op (*)(const spin_sys&, const flagvec&,     double, double, char)) &Rplane);
  def("Rplane_sp", (spin_op (*)(const spin_sys&, int,                double, double, char)) &Rplane_sp);

  def("Rxyz",    (spin_op (*)(const spin_sys&, int,                double, double, double)) &Rxyz);
  def("Rxyz",    (spin_op (*)(const spin_sys&, const std::string&, double, double, double)) &Rxyz);
  def("Rxyz",    (spin_op (*)(const spin_sys&,                     double, double, double)) &Rxyz);
//def("Rxyz",    (spin_op (*)(const spin_sys&, const flagvec&,     double, double, double)) &Rxyz);
  def("Rxyz_sp", (spin_op (*)(const spin_sys&, int,                double, double, char)) &Rxyz_sp);

  def("Rspace",   Rspace);

  def("R_Euler",    (spin_op (*)(const spin_sys&, int,                double, double, double)) &R_Euler);
  def("R_Euler",    (spin_op (*)(const spin_sys&, const std::string&, double, double, double)) &R_Euler);
  def("R_Euler",    (spin_op (*)(const spin_sys&,                     double, double, double)) &R_Euler);
  def("R_Euler_sp", (spin_op (*)(const spin_sys&,                     double, double, double)) &R_Euler_sp);

//def("R_Euler_plane", R_Euler_plane);

  def("Ixy",    (spin_op (*)(const spin_sys&, int,                double)) &Ixy);
  def("Fxy",    (spin_op (*)(const spin_sys&, int,                double)) &Fxy);
  def("Fxy",    (spin_op (*)(const spin_sys&, const std::string&, double)) &Fxy);
//def("Fxy",    (spin_op (*)(const spin_sys&, const flagvec&,     double)) &Fxy);
  def("Fxy",    (spin_op (*)(const spin_sys&,                     double)) &Fxy);
  def("Fxy_sp", (spin_op (*)(const spin_sys&,                     double)) &Fxy);

  def("Ip",    (spin_op (*)(const spin_sys&, int,                double)) &Ip);
  def("Fp",    (spin_op (*)(const spin_sys&, int,                double)) &Fp);
  def("Fp",    (spin_op (*)(const spin_sys&, const std::string&, double)) &Fp);
//def("Fp",    (spin_op (*)(const spin_sys&, const flagvec&,     double)) &Fp);
  def("Fp",    (spin_op (*)(const spin_sys&,                     double)) &Fp);
  def("Fp_sp", (spin_op (*)(const spin_sys&,                     double)) &Fp);

  def("Im",    (spin_op (*)(const spin_sys&, int,                double)) &Im);
  def("Fm",    (spin_op (*)(const spin_sys&, int,                double)) &Fm);
  def("Fm",    (spin_op (*)(const spin_sys&, const std::string&, double)) &Fm);
//def("Fm",    (spin_op (*)(const spin_sys&, const flagvec&,     double)) &Fm);
  def("Fm",    (spin_op (*)(const spin_sys&,                     double)) &Fm);
  def("Fm_sp", (spin_op (*)(const spin_sys&,                     double)) &Fm);

  def("Fplane",     Fplane);
  def("RotSpinOp", RotSpinOp);
  }
