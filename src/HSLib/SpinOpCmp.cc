...
void PySpinOpCmp()
  {
  def("Iu",   (spin_op (*)(const spin_sys&, int, int)) &Iu);
  def("Ie",   (spin_op (*)(const spin_sys&, int)) &Ie);
  def("Ix",   (spin_op (*)(const spin_sys&, int)) &Ix);
  def("Iy",   (spin_op (*)(const spin_sys&, int)) &Iy);
  def("Iz",   (spin_op (*)(const spin_sys&, int)) &Iz);
  def("Ip",   (spin_op (*)(const spin_sys&, int)) &Ip);
  def("Im",   (spin_op (*)(const spin_sys&, int)) &Im);
  def("Ia",   (spin_op (*)(const spin_sys&, int)) &Ia);
  def("Ib",   (spin_op (*)(const spin_sys&, int)) &Ib);
  def("Ipol", (spin_op (*)(const spin_sys&, double, int)) &Ipol);

  def("Fe",   (spin_op (*)(const spin_sys&, int)) &Fe);
  def("Fx",   (spin_op (*)(const spin_sys&, int)) &Fx);
  def("Fy",   (spin_op (*)(const spin_sys&, int)) &Fy);
  def("Fz",   (spin_op (*)(const spin_sys&, int)) &Fz);
  def("Fp",   (spin_op (*)(const spin_sys&, int)) &Fp);
  def("Fm",   (spin_op (*)(const spin_sys&, int)) &Fm);
  def("Fa",   (spin_op (*)(const spin_sys&, int)) &Fa);
  def("Fb",   (spin_op (*)(const spin_sys&, int)) &Fb);
  def("Fpol", (spin_op (*)(const spin_sys&, double, int)) &Fpol);

  def("Fe",   (spin_op (*)(const spin_sys&)) &Fe);
  def("Fx",   (spin_op (*)(const spin_sys&)) &Fx);
  def("Fy",   (spin_op (*)(const spin_sys&)) &Fy);
  def("Fz",   (spin_op (*)(const spin_sys&)) &Fz);
  def("Fp",   (spin_op (*)(const spin_sys&)) &Fp);
  def("Fm",   (spin_op (*)(const spin_sys&)) &Fm);
  def("Fa",   (spin_op (*)(const spin_sys&)) &Fa);
  def("Fb",   (spin_op (*)(const spin_sys&)) &Fb);
  def("Fpol", (spin_op (*)(const spin_sys&, double)) &Fpol);

  def("Fe",   (spin_op (*)(const spin_sys&, const std::string&)) &Fe);
  def("Fx",   (spin_op (*)(const spin_sys&, const std::string&)) &Fx);
  def("Fy",   (spin_op (*)(const spin_sys&, const std::string&)) &Fy);
  def("Fz",   (spin_op (*)(const spin_sys&, const std::string&)) &Fz);
  def("Fp",   (spin_op (*)(const spin_sys&, const std::string&)) &Fp);
  def("Fm",   (spin_op (*)(const spin_sys&, const std::string&)) &Fm);
  def("Fa",   (spin_op (*)(const spin_sys&, const std::string&)) &Fa);
  def("Fb",   (spin_op (*)(const spin_sys&, const std::string&)) &Fb);
  def("Fpol", (spin_op (*)(const spin_sys&, double, const std::string&)) &Fpol);

/*
  def("Fe",   (spin_op (*)(const spin_sys&, const flagvec&)) &Fe);
  def("Fx",   (spin_op (*)(const spin_sys&, const flagvec&)) &Fx);
  def("Fy",   (spin_op (*)(const spin_sys&, const flagvec&)) &Fy);
  def("Fz",   (spin_op (*)(const spin_sys&, const flagvec&)) &Fz);
  def("Fp",   (spin_op (*)(const spin_sys&, const flagvec&)) &Fp);
  def("Fm",   (spin_op (*)(const spin_sys&, const flagvec&)) &Fm);
  def("Fa",   (spin_op (*)(const spin_sys&, const flagvec&)) &Fa);
  def("Fb",   (spin_op (*)(const spin_sys&, const flagvec&)) &Fb);
  def("Fpol", (spin_op (*)(const spin_sys&, double, const flagvec&)) &Fpol)
*/

  def("Fe_sp",   (spin_op (*)(const spin_sys&)) &Fe_sp);
  def("Fx_sp",   (spin_op (*)(const spin_sys&)) &Fx_sp);
  def("Fy_sp",   (spin_op (*)(const spin_sys&)) &Fy_sp);
  def("Fz_sp",   (spin_op (*)(const spin_sys&)) &Fz_sp);
  def("Fp_sp",   (spin_op (*)(const spin_sys&)) &Fp_sp);
  def("Fm_sp",   (spin_op (*)(const spin_sys&)) &Fm_sp);
  def("Fa_sp",   (spin_op (*)(const spin_sys&)) &Fa_sp);
  def("Fb_sp",   (spin_op (*)(const spin_sys&)) &Fb_sp);
  def("Fpol_sp", (spin_op (*)(const spin_sys&, double)) &Fpol_sp);

  def("Faxis",   (spin_op (*)(const spin_sys&, int,                char)) &Faxis);
  def("Faxis",   (spin_op (*)(const spin_sys&, const std::string&, char)) &Faxis);
  def("Faxis",   (spin_op (*)(const spin_sys&,                     char)) &Faxis);
//def("Faxis",   (spin_op (*)(const spin_sys&, const flagvec&,     char)) &Faxis);
  def("Faxis_sp",(spin_op (*)(const spin_sys&,                     char)) &Faxis_sp);

  def("Fpol_gen_new",   (spin_op (*)(const spin_sys&,                     double)) &Fpol_gen_new);
  def("Fpol_gen_new",   (spin_op (*)(const spin_sys&, const std::string&, double)) &Fpol_gen_new);
//def("Fpol_gen_new",   (spin_op (*)(const spin_sys&, const flagvec&,     double)) &Fpol_gen_new);

  def("Fpol_gen", Fpol_gen);
