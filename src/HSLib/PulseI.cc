...
/*
    ...
    def(Ixpuls_sp,   "Ixpuls_sp");

    def((gen_op (*)(const spin_sys&, const gen_op&, int,                double)) &Iypuls, "Iypuls");
    def((gen_op (*)(const spin_sys&, const gen_op&,                     double)) &Iypuls, "Iypuls");
    def((gen_op (*)(const spin_sys&, const gen_op&, const std::string&, double)) &Iypuls, "Iypuls");

    def(Iypuls_sp,   "Iypuls_sp");

    def((gen_op (*)(const spin_sys&, const gen_op&, int,                double, double)) &Ixypuls, "Ixypuls");
    def((gen_op (*)(const spin_sys&, const gen_op&, const std::string&, double, double)) &Ixypuls, "Ixypuls");
    def((gen_op (*)(const spin_sys&, const gen_op&,                     double, double)) &Ixypuls, "Ixypuls");

    def(Ixypuls_sp,  "Ixypuls_sp");

//  def((gen_op (*)(const spin_sys&, const gen_op&, const flagvec&, double))         &Ixpuls,    "Ixpuls");
//  def((gen_op (*)(const spin_sys&, const gen_op&, const flagvec&, double))         &Iypuls,    "Iypuls");
//  def((gen_op (*)(const spin_sys&, const gen_op&, const flagvec&, double, double)) &Ixypuls,   "Ixypuls");
//  def((gen_op (*)(const spin_sys,                 const flagvec&, double))         &Ixpluls_U, "Ixpuls_U");

    def(Ixpuls_sp_U, "Ixpuls_sp_U");

    def((gen_op (*)(const spin_sys&, int, double))                &Ixpuls_U, "Ixpuls_U");
    def((gen_op (*)(const spin_sys&, const std::string&, double)) &Ixpuls_U, "Ixpuls_U");
    def((gen_op (*)(const spin_sys&, double))                     &Ixpuls_U, "Ixpuls_U");


    def((gen_op (*)(const spin_sys&, int, double)) &Iypuls_U, "Iypuls_U");
    def((gen_op (*)(const spin_sys&, const std::string&, double)) &Iypuls_U, "Iypuls_U");
    def((gen_op (*)(const spin_sys&, double)) &Iypuls_U, "Iypuls_U");
//def((gen_op (*)(const spin_sys, const flagvec&, double)) &Ixpluls_U, "Iypuls_U");
    def(Iypuls_sp_U, "Iypulse_sp_U");
    def((gen_op (*)(const spin_sys&, int, double, double)) &Ixypuls_U, "Ixypuls_U");
    def((gen_op (*)(const spin_sys&, const std::string&, double, double)) &Ixypuls_U, "Ixypuls_U");
