...
std::string spin_system::PyPrint()
  {
...
double spin_system::OmegaSSA()      const { return Omega();  }
double spin_system::OmegaSSB(int i) const { return Omega(i); }
...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(spinsystem_shifts,   spin_system::shifts,   0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(spinsystem_maxShift, spin_system::maxShift, 0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(spinsystem_minShift, spin_system::minShift, 0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(spinsystem_Js,       spin_system::Js,       0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(spinsystem_As,       spin_system::As,       0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(spinsystem_Om,       spin_system::Omega,    0, 1)

BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(spinsystem_read,     spin_system::read,  1, 3)

void PySpinSystem()
  {
//                                  The Class

  class_<spin_system, bases<spin_sys> >("spin_system")

//                              Constructors

    .def(init<>())
    .def(init<const spin_system&>())

//                                  Member Functions

    .def("shifts",       (void(spin_system::*)   (int))               0, spinsystem_shifts())
    .def("shift",        (void  (spin_system::*) (int, double)) &spin_system::shift)
    .def("shift",        (double(spin_system::*) (int) const)   &spin_system::shift)
    .def("maxShift",     (double(spin_system::*) (const std::string&))0, spinsystem_maxShift())
    .def("minShift",     (double(spin_system::*) (const std::string&))0, spinsystem_minShift())
    .def("medianShift",  &spin_system::medianShift)
    .def("lab_shift",    &spin_system::lab_shift)
    .def("offsetShifts", (void (spin_system::*)(double, int))                &spin_system::offsetShifts)
    .def("offsetShifts", (void (spin_system::*)(double, const std::string&)) &spin_system::offsetShifts)
    .def("PPM",          (void   (spin_system::*)(int, double)) &spin_system::PPM)
    .def("PPM",          (double (spin_system::*)(int) const)   &spin_system::PPM)

    .def("gfactor",      (double (spin_system::*)(int) const)   &spin_system::gfactor)
    .def("gfactor",      (void   (spin_system::*)(int, double)) &spin_system::gfactor)
    .def("eshift",       &spin_system::eshift)
    .def("lab_eshift",   &spin_system::lab_eshift)
    .def("efield",       &spin_system::efield)
    .def("efield_lab",   &spin_system::efield_lab)

    .def("Js", (void(spin_system::*) (int))0, spinsystem_Js())
    .def("J",  (void   (spin_system::*)(int, int, double)) &spin_system::J)
    .def("J",  (void   (spin_system::*)(double, int, int)) &spin_system::J)
    .def("J",  (double (spin_system::*)(int, int) const)   &spin_system::J)

    .def("As",  (void(spin_system::*) (int))0, spinsystem_As())
    .def("A",   (void   (spin_system::*)(int, int, double)) &spin_system::A)
    .def("A",   (void   (spin_system::*)(double, int, int)) &spin_system::A)
    .def("A",   (double (spin_system::*)(int, int) const)   &spin_system::A)
    .def("AHz", &spin_system::AHz)

    .def("Omega", (void   (spin_system::*)(double))                     &spin_system::Omega)
    .def("Omega", (void   (spin_system::*)(double, const std::string&)) &spin_system::Omega)
// sosi - this function presented some problems under GCC. It could not distinguish
//        it from the first overload. Consequently I have just made special functions
//        to handle things (OmegaSSA & OmegaSSB).
//    .def("Omega", (double (spin_system::*) (int))0, spinsystem_Om())
    .def("Omega", &spin_system::OmegaSSA)
    .def("Omega", &spin_system::OmegaSSB)
    .def("Omega", (double (spin_system::*)(const std::string&) const)   &spin_system::Omega)
    .def("Bo", &spin_system::Bo)
    .def("OmegaAdjust", &spin_system::OmegaAdjust)
    .def("FieldAdjust", &spin_system::FieldAdjust)

    .def("spectrometer_frequency", (void   (spin_system::*)(double)) &spin_system::spectrometer_frequency)
    .def("spectrometer_frequency", (double (spin_system::*)() const) &spin_system::spectrometer_frequency)

    .def("spflags", &spin_system::spflags, "spflags")
    .def("spflag",  (void (spin_system::*)(int, int, int) ) &spin_system::spflag)
    .def("spflag",  (int  (spin_system::*)(int, int) const) &spin_system::spflag)
 
    .def("center", &spin_system::center)

    .def("Nyquist", (double (spin_system::*)(int, double, double) const)                &spin_system::Nyquist)
    .def("Nyquist", (double (spin_system::*)(const std::string&, double, double) const) &spin_system::Nyquist)
    .def("Nyquist", (double (spin_system::*)(const Isotope&, double, double) const)     &spin_system::Nyquist)

//  Parameter Set Functions Not Yet Exported
//  Write Functions Not Yet Exported

    .def("read", (int(spin_system::*) (const std::string&,  int, int))0, spinsystem_read())
    .def("read", (int(spin_system::*) (ParameterSet&,       int, int))0, spinsystem_read())

//   Ask_Read Functions Not Exported
