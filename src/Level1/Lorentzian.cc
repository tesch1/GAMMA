...
complex DLorentzianA(double Weval, double W, double R)
  { return DLorentzian(Weval, W, R); }
row_vector DLorentzianB(int npts, double Wi, double Wf, double W, double R)
  { return DLorentzian(npts, Wi, Wf, W, R); }
row_vector DLorentzianC(int npts, double W, double R)
  { return DLorentzian(npts, W, R); }
row_vector DLorentzianD(int npts, double W, double R, int max1)
  { return DLorentzian(npts, W, R, max1); }
 
void PyLorentzian()
  {
  def("Lorentzian", LorentzianA);
  def("Lorentzian", LorentzianB);
  def("Lorentzian", LorentzianC);
  def("Lorentzian", LorentzianD);
  def("Lorentzian", LorentzianE);
  def("Lorentzian", LorentzianF);
  def("Lorentzian", LorentzianG);
  def("Lorentzian", LorentzianH);

  def("Lorentz_cut", Lorentz_cutA);
  def("Lorentz_cut", Lorentz_cutB);
//  def("Lorentz_cut", Lorentz_cutC);
//  def("Lorentz_cut", Lorentz_cutD);

  def("Lorentz_int", Lorentz_intA);
  def("Lorentz_int", Lorentz_intB);
  def("Lorentz_int", Lorentz_intC);
  def("Lorentz_int", Lorentz_intD);

// The functions ask_Lorentzian and read_Lorentzian have not been exported

  def("DLorentzian", DLorentzianA);
  def("DLorentzian", DLorentzianB);
  def("DLorentzian", DLorentzianC);
  def("DLorentzian", DLorentzianD);
  }
