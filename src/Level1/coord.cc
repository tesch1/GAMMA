...
coord operator / (const coord &pt1, double r)
  { coord pt(pt1); pt.cx /= r; pt.cy /= r; pt.cz /= r; return pt; }

string coord::PyPrint()
  {
...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(coord_Rad,   coord::Rad,   0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(coord_theta, coord::theta, 0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(coord_phi,   coord::phi,   0, 1)

BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(coord_Rx, coord::Rx, 1, 2)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(coord_Ry, coord::Ry, 1, 2)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(coord_Rz, coord::Rz, 1, 2)

BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(coord_xrotate, coord::xrotate, 1, 2)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(coord_yrotate, coord::yrotate, 1, 2)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(coord_zrotate, coord::zrotate, 1, 2)

BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(coord_param, coord::param, 1, 2)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(coord_read,  coord::read,  2, 3)

BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(coord_Cart2Sph, coord::Cart2Sph, 0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(coord_Sph2Cart, coord::Sph2Cart, 0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(coord_Cart2Cyl, coord::Cart2Cyl, 0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(coord_Cyl2Cart, coord::Cyl2Cart, 0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(coord_Sph2Cyl,  coord::Sph2Cyl,  0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(coord_Cyl2Sph,  coord::Cyl2Sph,  0, 1)

void PyCoord()
  {
//                                  The Class

  boost::python::class_<coord> ("coord", init<>())

//                                Constructors

    .def(init<double, double, double>())
    .def(init<const coord&>())
...
/*
    .def((double (coord::*)() const) &coord::x, "x");
    .def((double (coord::*)() const) &coord::y, "y");
    .def((double (coord::*)() const) &coord::z, "z");
    .def((void   (coord::*)(double)) &coord::x, "x");
    .def((void   (coord::*)(double)) &coord::y, "y");
    .def((void   (coord::*)(double)) &coord::z, "z");
    .def((void   (coord::*)(double, double, double)) &coord::xyz,   "xyz");
    .def((void   (coord::*)(const coord&))           &coord::xyz,   "xyz");
*/

    .def("norm", &coord::norm)
 
    .def("Rad",   (double(coord::*) (const coord&))0, coord_Rad())
    .def("theta", (double(coord::*) (const coord&))0, coord_theta())
    .def("phi",   (double(coord::*) (const coord&))0, coord_phi())

    .def("invert", &coord::invert)

    .def("Rx", (matrix(coord::*) (double, int))0, coord_Rx())
    .def("Ry", (matrix(coord::*) (double, int))0, coord_Ry())
    .def("Rz", (matrix(coord::*) (double, int))0, coord_Rz())

    .def("xrotate", (coord(coord::*) (double, int))0, coord_xrotate())
    .def("yrotate", (coord(coord::*) (double, int))0, coord_yrotate())
    .def("zrotate", (coord(coord::*) (double, int))0, coord_zrotate())

    .def("Ralpha", &coord::Ralpha)
    .def("Rbeta",  &coord::Rbeta)
    .def("Rgamma", &coord::Rgamma)
    .def("REuler", &coord::REuler)

/*
    .def((coord (coord::*)(double, double, double)) &coord::rotate, "rotate");
    .def((coord (coord::*)(coord&))                 &coord::rotate, "rotate");
*/

    .def("trans_x", &coord::trans_x)
    .def("trans_y", &coord::trans_y)
    .def("trans_z", &coord::trans_z)

    .def("trans_x_ip", &coord::trans_x_ip)
    .def("trans_y_ip", &coord::trans_y_ip)
    .def("trans_z_ip", &coord::trans_z_ip)

/*
    .def((coord (coord::*)(double, double, double)) &coord::translate, "translate");
    .def((coord (coord::*)(const coord&) const)     &coord::translate, "translate");
    .def((void  (coord::*)(double, double, double)) &coord::translate_ip, "translate_ip");
    .def((void  (coord::*)(const coord&))           &coord::translate_ip, "translate_ip");
*/
...
/*
    ...
    .def(matrix * self)
*/
    .def("param", (SinglePar(coord::*) (const std::string&, const std::string&))0, coord_param())
//    .def("read",  (int(coord::*) (const std::string&, int, int))0, coord_read())
//    .def("read",  (int(coord::*) (const ParameterSet, int, int))0, coord_read())

//    .def("length", length);

    .def("Cart2Sph", (coord(coord::*) (int))0, coord_Cart2Sph())
    .def("Sph2Cart", (coord(coord::*) (int))0, coord_Sph2Cart())
    .def("Cart2Cyl", (coord(coord::*) (int))0, coord_Cart2Cyl())
    .def("Cyl2Cart", (coord(coord::*) (int))0, coord_Cyl2Cart())
    .def("Sph2Cyl",  (coord(coord::*) (int))0, coord_Sph2Cyl())
    .def("Cyl2Sph",  (coord(coord::*) (int))0, coord_Cyl2Sph())
...
//			  Global Coordinate Constants
  ...
  boost::python::scope().attr("UnitX")      = UnitX;
  boost::python::scope().attr("UnitY")      = UnitY;
  boost::python::scope().attr("UnitZ")      = UnitZ;
  boost::python::scope().attr("coord0")     = coord0;

//                               Global Functions

/*
  def((double (*)(double, double, double))     &Rad,   "Rad");
  def((double (*)(const coord&, const coord&)) &Rad,   "Rad");
  def((double (*)(double, double, double))     &theta, "theta");
  def((double (*)(const coord&, const coord&)) &theta, "theta");
  def((double (*)(double, double, double))     &phi,   "phi");
  def((double (*)(const coord&, const coord&)) &phi,   "phi");
