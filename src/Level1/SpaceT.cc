...
string Cartesian_SPACE_T_py1(const space_T &SphT)
  {
  stringstream sstr;
  double x,y,z;
  double Axx, Axy, Axz;
...
//                                  The Class
  ...
  boost::python::class_<space_T> ("space_T", init<>())

//                                Constructors
    .def(init<const space_T&>())
    .def(init<const space_T&, int>())
...
//                              Member Functions
    ...
    .def("PASys",    &space_T::PASys)
    .def("PASys_EA", &space_T::PASys_EA)

    .def("alpha", &space_T::alpha)
    .def("beta",  &space_T::beta)
    .def("gamma", &space_T::gamma)
