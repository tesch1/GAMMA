...
// ----------------------------------------------------------------------------
//                   ASCII Data File Output, Single Vector
// ----------------------------------------------------------------------------

/* The GP_1D functions make use of default argument values which are not
   handled cleanly in Boost.Python. So the functons below simply take arguments
   with no defaults then call the normal GP_1D function so the defaults are
   used.                                                                     */
...
/* The Gnuplot1D functions make use of default argument values which are not
   handled cleanly in Boost.Python. So the functons below simply take arguments
   with no defaults then call the normal Gnuplot1D function so the defaults 
   are used.                                                                 */
...
/* These next functions are those which will be used to make Python classes to
   handle STL vectors of strings and vectors of row_vector. Both of these are
   used in function calls in this module.                                     */
