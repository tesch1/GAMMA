...
void FIDP1(gen_op& sig0,             gen_op& D,super_op& L,double td,int N,row_vector& fid,double CO) { FID(sig0,     D,L,td,N,fid,CO); }
void FIDP2(gen_op& sig0,gen_op& sigf,gen_op& D,super_op& L,double td,int N,row_vector& fid,double CO) { FID(sig0,sigf,D,L,td,N,fid,CO); }

void FIDP3(gen_op& sig0,             gen_op& D,super_op& L,row_vector& fid,double td,int N,double CO) { FID(sig0,     D,L,fid,td,N,CO); }
void FIDP4(gen_op& sig0,gen_op& sigf,gen_op& D,super_op& L,row_vector& fid,double td,int N,double CO) { FID(sig0,sigf,D,L,fid,td,N,CO); }

row_vector FIDP5(gen_op& sig0,             gen_op& D,super_op& L,double td,int N,double CO) { return FID(sig0,     D,L,td,N,CO); }
row_vector FIDP6(gen_op& sig0,gen_op& sigf,gen_op& D,super_op& L,double td,int N,double CO) { return FID(sig0,sigf,D,L,td,N,CO); }

void FIDP7(gen_op& sig, gen_op& D, super_op& G, row_vector &data, int N) { FID(sig,D,G,data,N); }
void FIDP8(gen_op& sig, gen_op& D, LSprop&   G, row_vector &data, int N) { FID(sig,D,G,data,N); }

row_vector FIDP9(gen_op& sig, gen_op& D, super_op& G, int N) { return FID(sig,D,G,N); }
row_vector FIDPZ(gen_op& sig, gen_op& D, LSprop&   G, int N) { return FID(sig,D,G,N); }
...
BOOST_PYTHON_FUNCTION_OVERLOADS(lslib_FIDP1, FIDP1, 6, 7)
BOOST_PYTHON_FUNCTION_OVERLOADS(lslib_FIDP2, FIDP2, 7, 8)
BOOST_PYTHON_FUNCTION_OVERLOADS(lslib_FIDP3, FIDP3, 5, 7)
BOOST_PYTHON_FUNCTION_OVERLOADS(lslib_FIDP4, FIDP4, 6, 8)
BOOST_PYTHON_FUNCTION_OVERLOADS(lslib_FIDP5, FIDP5, 5, 6)
BOOST_PYTHON_FUNCTION_OVERLOADS(lslib_FIDP6, FIDP6, 6, 7)
BOOST_PYTHON_FUNCTION_OVERLOADS(lslib_FIDP7, FIDP7, 4, 5)
BOOST_PYTHON_FUNCTION_OVERLOADS(lslib_FIDP8, FIDP8, 4, 5)

void PyLSAcquire()
  {
  def("acquire", (void(*)(gen_op&,          gen_op&, super_op&, double, int, row_vector&, double))0, lslib_FIDP1());
  def("acquire", (void(*)(gen_op&, gen_op&, gen_op&, super_op&, double, int, row_vector&, double))0, lslib_FIDP2());
  def("FID",     (void(*)(gen_op&,          gen_op&, super_op&, double, int, row_vector&, double))0, lslib_FIDP1());
  def("FID",     (void(*)(gen_op&, gen_op&, gen_op&, super_op&, double, int, row_vector&, double))0, lslib_FIDP2());

  def("acquire", (void(*)(gen_op&,          gen_op&, super_op&, row_vector&, double, int, double))0, lslib_FIDP3());
  def("acquire", (void(*)(gen_op&, gen_op&, gen_op&, super_op&, row_vector&, double, int, double))0, lslib_FIDP4());
  def("FID",     (void(*)(gen_op&,          gen_op&, super_op&, row_vector&, double, int, double))0, lslib_FIDP3());
  def("FID",     (void(*)(gen_op&, gen_op&, gen_op&, super_op&, row_vector&, double, int, double))0, lslib_FIDP4());

  def("acquire", (row_vector(*)(gen_op&,          gen_op&, super_op&, double, int, double))0, lslib_FIDP5());
  def("acquire", (row_vector(*)(gen_op&, gen_op&, gen_op&, super_op&, double, int, double))0, lslib_FIDP6());
  def("FID",     (row_vector(*)(gen_op&,          gen_op&, super_op&, double, int, double))0, lslib_FIDP5());
  def("FID",     (row_vector(*)(gen_op&, gen_op&, gen_op&, super_op&, double, int, double))0, lslib_FIDP6());

  def("acquire", (void(*)(gen_op&, gen_op&, super_op&, row_vector&, int))0, lslib_FIDP7());
  def("acquire", (void(*)(gen_op&, gen_op&, LSprop&,   row_vector&, int))0, lslib_FIDP8());
  def("FID",     (void(*)(gen_op&, gen_op&, super_op&, row_vector&, int))0, lslib_FIDP7());
  def("FID",     (void(*)(gen_op&, gen_op&, LSprop&,   row_vector&, int))0, lslib_FIDP8());

  def("acquire", (row_vector(*)(gen_op&, gen_op&, super_op&, int)) &FIDP7);
  def("acquire", (row_vector(*)(gen_op&, gen_op&, LSprop&,   int)) &FIDP8);
  def("FID",     (row_vector(*)(gen_op&, gen_op&, super_op&, int)) &FIDP7);
  def("FID",     (row_vector(*)(gen_op&, gen_op&, LSprop&,   int)) &FIDP8);
