...
std::string sys_dynamic::PyPrint()
  {
  std::stringstream sstr;
  std::string hdr("Dynamic Spin System");
  std::string syn = name();
  if(syn.length())
    hdr += std::string(" ") + syn;
  sstr << CenterString(hdr);

  int ns = spins();
  if(!ns)					// If the system has no spins
    {						// we'll just say so and exit
    sstr << std::endl
         << CenterString("No Spins In System")
         << std::endl;
    return sstr.str();
    }
  ...
  nr = Strs.size();
  int j;
  for(j=0; j<nr; j++)				// Print rows. Rows each have
    sstr << lst << Strs[j];			// different data, cols are
...
void sys_dynamic::genString(std::stringstream& sstr)
  {		
  if(spins())		
    {
    sstr << "\n";
...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(sysdyn_shifts,   sys_dynamic::shifts,   0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(sysdyn_coords,   sys_dynamic::coords,   1, 2)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(sysdyn_read,     sys_dynamic::read,     1, 3)

void PySysDynamic()
  {
//                                  The Class

  class_<sys_dynamic, bases<spin_system, coord_vec> >("sys_dynamic")

//                              Constructors

    .def(init<>())
    .def(init<int>())
    .def(init<const sys_dynamic&>())

//                                  Member Functions

    .def("shifts",       (void  (sys_dynamic::*) (int))          0, sysdyn_shifts())
    .def("shift",        (void  (sys_dynamic::*) (int, double)) &sys_dynamic::shift)
    .def("shift",        (void  (sys_dynamic::*) (double, int)) &sys_dynamic::shift)
    .def("shift",        (double(sys_dynamic::*) (int) const)   &sys_dynamic::shift)
    .def("offsetShifts", (void  (sys_dynamic::*)(double, int))                &sys_dynamic::offsetShifts)
    .def("offsetShifts", (void  (sys_dynamic::*)(double, const std::string&)) &sys_dynamic::offsetShifts)
    .def("PPM",          &sys_dynamic::PPM)

    .def("delz",         (double  (sys_dynamic::*) (int) const)           &sys_dynamic::delz)
    .def("delz",         (void    (sys_dynamic::*) (int, double))         &sys_dynamic::delz)
    .def("Ceta",         (double  (sys_dynamic::*) (int) const)           &sys_dynamic::Ceta)
    .def("Ceta",         (void    (sys_dynamic::*) (int, double))         &sys_dynamic::Ceta)
    .def("TC",           (space_T (sys_dynamic::*) (int) const)           &sys_dynamic::TC)
    .def("TC",           (void    (sys_dynamic::*) (const space_T&, int)) &sys_dynamic::TC)
    .def("xiC_vector",   &sys_dynamic::xiC_vector)
    .def("xiC",          &sys_dynamic::xiC)
    .def("CSA",          &sys_dynamic::CSA)
// sosi - why is the function TC rather than AC... name conflict?

    .def("coords",       (void  (sys_dynamic::*) (const coord_vec&, int)) 0, sysdyn_coords())
    .def("Coord",          &sys_dynamic::Coord)

    .def("DCC",         (double  (sys_dynamic::*) (int, int) const)           &sys_dynamic::DCC)
    .def("DCC",         (void    (sys_dynamic::*) (int, int, double))         &sys_dynamic::DCC)
    .def("Ddelz",       (double  (sys_dynamic::*) (int, int) const)           &sys_dynamic::Ddelz)
    .def("Ddelz",       (void    (sys_dynamic::*) (int, int, double))         &sys_dynamic::Ddelz)
    .def("Deta",        (double  (sys_dynamic::*) (int, int) const)           &sys_dynamic::Deta)
    .def("Deta",        (void    (sys_dynamic::*) (int, int, double))         &sys_dynamic::Deta)
    .def("AD",          (space_T (sys_dynamic::*) (int, int) const)           &sys_dynamic::AD)
    .def("AD",          (space_T (sys_dynamic::*) (int)      const)           &sys_dynamic::AD)

    .def("dipoles",     &sys_dynamic::dipoles)
    .def("dipole",      &sys_dynamic::dipole)
    .def("xiD_matrix",  &sys_dynamic::xiD_matrix)
    .def("Dip",         &sys_dynamic::Dip)

    .def("QCC",          (double  (sys_dynamic::*) (int) const)           &sys_dynamic::QCC)
    .def("QCC",          (void    (sys_dynamic::*) (int, double))         &sys_dynamic::QCC)
    .def("Qdelz",        (double  (sys_dynamic::*) (int) const)           &sys_dynamic::Qdelz)
    .def("Qdelz",        (void    (sys_dynamic::*) (int, double))         &sys_dynamic::Qdelz)
    .def("Qeta",         (double  (sys_dynamic::*) (int) const)           &sys_dynamic::Qeta)
    .def("Qeta",         (void    (sys_dynamic::*) (int, double))         &sys_dynamic::Qeta)
    .def("TQ",           (space_T (sys_dynamic::*) (int) const)           &sys_dynamic::TQ)
    .def("TQ",           (void    (sys_dynamic::*) (const space_T&, int)) &sys_dynamic::TQ)
    .def("xiQ_vector",   &sys_dynamic::xiQ_vector)
    .def("xiQ",          &sys_dynamic::xiQ)
    .def("Quad",         &sys_dynamic::Quad)

    .def("TR",           &sys_dynamic::TR)
    .def("tauR",         &sys_dynamic::tauR)
    .def("xiR_vector",   &sys_dynamic::xiR_vector)
    .def("xiR",          &sys_dynamic::Quad)

// Parameter set functions not exported

    .def("read", (int(sys_dynamic::*) (const std::string&,  int, int))0, sysdyn_read())
    .def("read", (int(sys_dynamic::*) (ParameterSet&,       int, int))0, sysdyn_read())

// Ask read functions not exported

    .def("taus", &sys_dynamic::taus)
    .def("taux", (double (sys_dynamic::*)() const) &sys_dynamic::taux)
    .def("taux", (void   (sys_dynamic::*)(double)) &sys_dynamic::taux)
    .def("tauy", (double (sys_dynamic::*)() const) &sys_dynamic::tauy)
    .def("tauy", (void   (sys_dynamic::*)(double)) &sys_dynamic::tauy)
    .def("tauz", (double (sys_dynamic::*)() const) &sys_dynamic::tauz)
    .def("tauz", (void   (sys_dynamic::*)(double)) &sys_dynamic::tauz)

    .def("Kex_zero",                                              &sys_dynamic::Kex_zero)
    .def("Kex",      (double (sys_dynamic::*)(int)   const)       &sys_dynamic::Kex)
    .def("Kex",      (void   (sys_dynamic::*)(double, int))       &sys_dynamic::Kex)
    .def("Kex",      (matrix (sys_dynamic::*)()      const)       &sys_dynamic::Kex)
    .def("Kex",      (void   (sys_dynamic::*)(int, int, double))  &sys_dynamic::Kex)
    .def("Kex",      (void   (sys_dynamic::*)(int, int*, double)) &sys_dynamic::Kex)

//  .def("MExProcs", &sys_dynamic::MExProcs)


//                           Python Specialty Functions

    .def("__str__", &sys_dynamic::PyPrint)
  ;
  }
