...
//                                  The Class
  ...
  boost::python::class_<LSprop>("LSprop", init<>())

//                                Constructors

    .def(init<int>())
    .def(init<const gen_op&, double>())
    .def(init<const gen_op&, double, bool>())
    .def(init<const HSprop&>())
    .def(init<const super_op&, double>())
    .def(init<const super_op&, const densop&, double>())
    .def(init<const super_op&>())
    .def(init<const LSprop&>())

//                               Member Functions

    .def("time",   &LSprop::time)
    .def("length", (double (LSprop::*)() const) &LSprop::length)
    .def("dim",    &LSprop::dim)
    .def("HS",     &LSprop::HS)
    .def("LS",     &LSprop::LS)
    .def("LOp",    &LSprop::LOp)
    .def("L",      &LSprop::L)
    .def("length", (void (LSprop::*)(double)) &LSprop::length)

    .def("SetEBR",       &HSprop::SetEBR)
    .def("SetBasis",     &HSprop::SetBasis)

    .def("evolve",       &HSprop::evolve)
...
/*
    .def("sim_trans",    &HSprop::sim_trans)
    .def("sim_trans_ip", &HSprop::sim_trans_ip)
    .def("Pow",          &HSprop::Pow)
