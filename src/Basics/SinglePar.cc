...
int SinglePar::parseSPAR1(string name, int i, string state, int warn) const
  { return parse(name, i, state, warn); }

int SinglePar::parseSPAR2(string name, double d, string state, int warn) const
  { return parse(name, d, state, warn); }

int SinglePar::parseSPAR3(string name, string val, string state, int warn) const
  { return parse(name, val, state, warn); }

int SinglePar::parseSPAR4(string name, double dx, double dy, double dz,
                                                string state, int warn) const
  { return parse(name, dx, dy, dz, state, warn); }

int SinglePar::parseSPAR5(string name, int rank, double diso, double delz,
               double deta, double alpha, double beta, double gamma, string state, int warn) 
  { return parse(name, rank, diso, delz, deta, alpha, beta, gamma, state, warn); }

string SinglePar::PyPrint()
  {
...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(SinglePar_parseA,  SinglePar::parse,  3, 4)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(SinglePar_parseB,  SinglePar::parse,  5, 6)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(SinglePar_parseC,  SinglePar::parse,  9, 10)
...
//                              Constructors
    ...
    .def(init<const std::string&, int, const std::string&, const std::string&>())
    .def(init<const std::string&, int,                     const std::string&>())
    .def(init<const std::string&, double,                  const std::string&>())
    .def(init<const std::string&, const std::string&,      const std::string&>())
    .def(init<const std::string&>())

//                            Member Functions

    .def("name",  (void              (SinglePar::*) (const std::string&)) &SinglePar::name)
    .def("name",  (const std::string&(SinglePar::*) () const)             &SinglePar::name,
                                              return_value_policy<copy_const_reference>())
    .def("type",  (int               (SinglePar::*) () const)             &SinglePar::type)

    .def("data",  (const std::string&(SinglePar::*) () const)             &SinglePar::data,
                                              return_value_policy<copy_const_reference>())

    .def("state", (void              (SinglePar::*) (const std::string&)) &SinglePar::state)

    .def("state", (const std::string&(SinglePar::*) () const)             &SinglePar::state,
                                              return_value_policy<copy_const_reference>())

// The function getNS and all parse functions will alter one or more of the 
// function input arguments (passed as references) & return boolean. They are 
// not directly exported into Python because of this aspect, namely the 
// alteration of input arguments. As such we must use an altered version of 
// these functions. See Python Specialty functions below.

    .def("GetNS", &SinglePar::GetNS)
    .def("parse", (bool(SinglePar::*) (std::string&, int&,         std::string&, int) const)0, SinglePar_parseA())
    .def("parse", (bool(SinglePar::*) (std::string&, double&,      std::string&, int) const)0, SinglePar_parseA())
    .def("parse", (bool(SinglePar::*) (std::string&, std::string&, std::string&, int) const)0, SinglePar_parseA())
    .def("parse", (bool(SinglePar::*) (std::string&, double&,      double&,      double&,
                                                                   std::string&, int) const)0, SinglePar_parseB())
    .def("parse", (bool(SinglePar::*) (std::string&, int&,         double&,      double&,
                               double&, double&, double&, double&, std::string&, int) const)0, SinglePar_parseC())
...
//                          Python Specialty Functions
    ...
    .def("parse",   &SinglePar::parseSPAR1)
    .def("parse",   &SinglePar::parseSPAR2)
    .def("parse",   &SinglePar::parseSPAR3)
    .def("parse",   &SinglePar::parseSPAR4)
    .def("parse",   &SinglePar::parseSPAR5)
    .def("__str__", &SinglePar::PyPrint)
    ;
  }
