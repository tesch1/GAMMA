...
**                              G A M M A				**
**									**
**      PyGAMMA BWR Module Python Interface	     Interface		**
**									**
**      Copyright (c) 2002						**
**      Scott Smith							**
...
** when the GAMMA BWR module is built into a Python module without	**
...
#include <BWRRelax/relaxWBRIF.h>			// All of BWR module
...
// ____________________________________________________________________________
// ____________________________________________________________________________
// K                     GAMMA Level2 Module Exports
// ____________________________________________________________________________
// ____________________________________________________________________________

  PyBWRDip();					// Dipole-Dipole Relaxation
  PyBWRQuad();					// Quadrupolar Relaxaton
  PyBWRExch();					// Exchange superoperators
  }
