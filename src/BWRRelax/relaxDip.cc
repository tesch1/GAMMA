...
BOOST_PYTHON_FUNCTION_OVERLOADS(BWR_RDD1,     RDD,      6, 8)
BOOST_PYTHON_FUNCTION_OVERLOADS(BWR_RDD2,     RDD,      2, 4)
BOOST_PYTHON_FUNCTION_OVERLOADS(BWR_RDD3,     RDD,      4, 6)
BOOST_PYTHON_FUNCTION_OVERLOADS(BWR_RDD_Jgen, RDD_Jgen, 2, 4)
BOOST_PYTHON_FUNCTION_OVERLOADS(BWR_xiD0,     xiD,      1, 2)
BOOST_PYTHON_FUNCTION_OVERLOADS(BWR_xiD2,     xiD,      2, 4)
BOOST_PYTHON_FUNCTION_OVERLOADS(BWR_xiD3,     xiD,      3, 4)
BOOST_PYTHON_FUNCTION_OVERLOADS(BWR_DCC,      DCC,      3, 4)
BOOST_PYTHON_FUNCTION_OVERLOADS(BWR_NOE,      NOE,      3, 4)
BOOST_PYTHON_FUNCTION_OVERLOADS(BWR_R2_DDMQT, R2_DDMQT, 3, 4)

void PyBWRDip()
  {
  def("RDD",      (void(*)    (super_op&, const sys_dynamic&, gen_op&, double*, double*, double, int, int))0, BWR_RDD1());
  def("RDD",      (super_op(*)(const sys_dynamic&, gen_op&, int, int))0, BWR_RDD2());
  def("RDD",      (super_op(*)(const spin_system&, gen_op&, double, matrix&, int, int))0, BWR_RDD3());
  def("RDD_Jgen", (super_op(*)(const sys_dynamic&, gen_op&,                  int, int))0, BWR_RDD_Jgen());

  def("xiD", (matrix(*)(const sys_dynamic&, double))0, BWR_xiD0());
  def("xiD", (double(*)(const sys_dynamic&, int,     int)) &xiD);
  def("xiD", (matrix(*)(const spin_system&, matrix&, int,    double))0, BWR_xiD2());
  def("xiD", (double(*)(double,             double,  double, int))0,    BWR_xiD3());

  def("DCC", (matrix(*)(const sys_dynamic&))           &DCC);
  def("DCC", (double(*)(const sys_dynamic&, int, int)) &DCC);
  def("DCC", (double(*)(double, double, double, int))0, BWR_DCC());

  def("R1_DD", (row_vector(*)(const sys_dynamic&))           &R1_DD);
  def("R1_DD", (double(*)    (const sys_dynamic&, int))      &R1_DD);
  def("R1_DD", (double(*)    (const sys_dynamic&, int, int)) &R1_DD);

  def("R1_DD_max", (double(*)(const sys_dynamic&))                     &R1_DD_max);
  def("R1_DD_max", (double(*)(const sys_dynamic&, int))                &R1_DD_max);
  def("R1_DD_max", (double(*)(const sys_dynamic&, const std::string&)) &R1_DD_max);

  def("T1_DD", (row_vector(*)(const sys_dynamic&))           &T1_DD);
  def("T1_DD", (double(*)    (const sys_dynamic&, int))      &T1_DD);
  def("T1_DD", (double(*)    (const sys_dynamic&, int, int)) &T1_DD);

  def("T1_DD_max", (double(*)(const sys_dynamic&))                     &T1_DD_max);
  def("T1_DD_max", (double(*)(const sys_dynamic&, int))                &T1_DD_max);
  def("T1_DD_max", (double(*)(const sys_dynamic&, const std::string&)) &T1_DD_max);


  def("R2_DD", (row_vector(*)(const sys_dynamic&))           &R2_DD);
  def("R2_DD", (double(*)    (const sys_dynamic&, int))      &R2_DD);
  def("R2_DD", (double(*)    (const sys_dynamic&, int, int)) &R2_DD);

  def("R2_DD_max", (double(*)(const sys_dynamic&))                     &R2_DD_max);
  def("R2_DD_max", (double(*)(const sys_dynamic&, int))                &R2_DD_max);
  def("R2_DD_max", (double(*)(const sys_dynamic&, const std::string&)) &R2_DD_max);

  def("T2_DD", (row_vector(*)(const sys_dynamic&))           &T2_DD);
  def("T2_DD", (double(*)    (const sys_dynamic&, int))      &T2_DD);
  def("T2_DD", (double(*)    (const sys_dynamic&, int, int)) &T2_DD);

  def("T2_DD_max", (double(*)(const sys_dynamic&))                     &T2_DD_max);
  def("T2_DD_max", (double(*)(const sys_dynamic&, int))                &T2_DD_max);
  def("T2_DD_max", (double(*)(const sys_dynamic&, const std::string&)) &T2_DD_max);

  def("LWhh_DD", (row_vector(*)(const sys_dynamic&))           &LWhh_DD);
  def("LWhh_DD", (double(*)    (const sys_dynamic&, int))      &LWhh_DD);
  def("LWhh_DD", (double(*)    (const sys_dynamic&, int, int)) &LWhh_DD);

  def("LWhh_DD_max", (double(*)(const sys_dynamic&))                     &LWhh_DD_max);
  def("LWhh_DD_max", (double(*)(const sys_dynamic&, int))                &LWhh_DD_max);
  def("LWhh_DD_max", (double(*)(const sys_dynamic&, const std::string&)) &LWhh_DD_max);

  def("NOE",      (double(*)(const sys_dynamic&, int, int, double))0, BWR_NOE());
  def("R2_DDMQT", (row_vector(*)(const sys_dynamic&, int))             &R2_DDMQT);
  def("R2_DDMQT", (double(*)(const sys_dynamic&, int, int, int))0, BWR_R2_DDMQT());
  }
