...
**	                         G A M M A				**
**				          				**
**	Auxiliary Relaxation Functions                 Interface	**
**						        		**
**	Copyright (c) 1993		        			**
**	Scott A. Smith		        				**
...
** Description								**
**									**
** Herein are functions useful in dealing with relaxation phenomena.	**
**									**
*************************************************************************/

///Chapter Auxiliary Relaxation Functions
///Section Overview
///Body The ...
///Section Available Relaxation Auxiliary Functions

#ifndef   Relax_aux_h_			// Is this file already included?
#  define Relax_aux_h_ 1		// If no, then remember it
...
MSVCDLL void print(super_op& LOp, double cutoff=1.e-6, int nc=4, int ri=0);
...
//MSVCDLL super_op Hsuper(gen_op& Heff);
...
//MSVCDLL super_op HsuperX(gen_op& Heff);
