...
**                              G A M M A				**
**									**
**      PyGAMMA Testing Module Python Interface           Interface	**
**									**
**      Copyright (c) 2002						**
**      Scott Smith							**
...
#ifndef _PyTesting_h_			// Is this file already included?
#define _PyTesting_h_ 1			// If no, then remember it
