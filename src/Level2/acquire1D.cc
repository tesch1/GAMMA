...
//BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(ttab_construct,   TTable1D::TTable1D,       2, 3)

void PyAcquire1D()
  {
//                                  The Class

  boost::python::class_<acquire1D>("acquire1D", init<>())

//                                Constructors

//    .def(init<const acquire1D&>())
    .def(init<gen_op&, gen_op&>())
    .def(init<gen_op&, gen_op&, int>())
    .def(init<gen_op&, HSprop&>())
    .def(init<gen_op&, HSprop&, int>())
/*
...
*/
    ...
    .def("L",        &acquire1D::L,       return_value_policy<copy_const_reference>())
    .def("D",        &acquire1D::D,       return_value_policy<copy_const_reference>())
    .def("S",        &acquire1D::S)
    .def("Sinv",     &acquire1D::Sinv,    return_value_policy<copy_const_reference>())
    .def("TTable",   &acquire1D::TTable,  return_value_policy<copy_const_reference>())
    .def("Detector", &acquire1D::Detector)

//  .def("T", (row_vector (acquire1D::*)(gen_op&, double,      int))    &acquire1D::T)
//  .def("T", (row_vector (acquire1D::*)(gen_op&, int,         double)) &acquire1D::T)
//  .def("T", (void       (acquire1D::*)(gen_op&, row_vector&, double)) &acquire1D::T)


//  .def("F", (row_vector (acquire1D::*)(gen_op&, int,          double, double))  &acquire1D::F)
//  .def("F", (void       (acquire1D::*)(gen_op&, row_vector& , double, double)) &acquire1D::F)

/*

    .def((row_vector (acquire1D::*)(const gen_op&, double,      int))    &acquire1D::T,  "T");
    .def((row_vector (acquire1D::*)(const gen_op&, int,         double)) &acquire1D::T,  "T");
    .def((void       (acquire1D::*)(const gen_op&, row_vector&, double)) &acquire1D::T,  "T");

    .def((row_vector (acquire1D::*)(const gen_op&, int,         double, double)) &acquire1D::F,  "F");
    .def((void       (acquire1D::*)(const gen_op&, row_vector&, double, double)) &acquire1D::F,  "F");

    .def((row_vector (acquire1D::*)(const gen_op&, int,         double, double)) &acquire1D::FD, "FD");
    .def((void       (acquire1D::*)(const gen_op&, row_vector&, double, double)) &acquire1D::FD, "FD");

    .def((const TTable1D& (acquire1D::*)(const gen_op&)) &acquire1D::table, "table");
//    .def((const TTable1D& (acquire1D::*)())              &acquire1D::table, "table");

    .def((void    (acquire1D::*)(double,          int)) &acquire1D::offset,     "offset");
    .def((void    (acquire1D::*)(double, int,     int)) &acquire1D::offset,     "offset");
    .def((void    (acquire1D::*)(double))               &acquire1D::FRscale,    "FRscale");
    .def((void    (acquire1D::*)(double,          int)) &acquire1D::FRscale,    "FRscale");
    .def((void    (acquire1D::*)(double))               &acquire1D::Iscale,     "Iscale");
    .def((void    (acquire1D::*)(double,          int)) &acquire1D::Iscale,     "Iscale");
    .def((void    (acquire1D::*)(double,          int)) &acquire1D::broaden,    "broaden");
    .def((void    (acquire1D::*)(double, int,     int)) &acquire1D::broaden,    "broaden");
    .def((void    (acquire1D::*)(double))               &acquire1D::resolution, "resolution");
    .def((void    (acquire1D::*)(double, complex&))     &acquire1D::pcorrect,   "pcorrect");
//    .def((complex (acquire1D::*)(double&, double, int)) &acquire1D::pcorrect,   "pcorrect");

*/

    .def("Wmax",          &acquire1D::Wmax)
    .def("LWmax",         &acquire1D::LWmax)
    .def("setSort",       &acquire1D::setSort)
    .def("setConv",       &acquire1D::setConv)

    .def("ls",          &acquire1D::ls)
//    .def("size",        &acquire1D::size)
//    .def("full_size"    &acquire1D::full_size)
    .def("transitions", &acquire1D::transitions)
...
//  .def(str(self))
    ...
    .def("write", (void (acquire1D::*)(const std::string&) const) &acquire1D::write)
    .def("read",  (void (acquire1D::*)(const std::string&))       &acquire1D::read)
