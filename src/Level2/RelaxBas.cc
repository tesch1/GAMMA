...
using boost::python::init;			// Boost.Python init (construct)
using boost::python::def;
using boost::python::self;

BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(RBasic_SetSystem, RBasic::SetSystem, 1, 2)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(RBasic_SetH0,     RBasic::SetH0,     1, 2)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(RBasic_SetDet,    RBasic::SetDet,    1, 2)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(RBasic_SetSigInf, RBasic::SetSigInf, 1, 2)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(RBasic_SigmaCEq,  RBasic::SigmaCEq,  0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(RBasic_HC,        RBasic::HC,        0, 1)

void PyRelaxBas()
  {
//                                  The Class

  boost::python::class_<RBasic>("RBasic", init<>())

//                                Constructors

    .def(init<const row_vector&>())
    .def(init<const RBasic&>())

//                           Member Functions

    .def("spins", &RBasic::spins)
    .def("HS",    &RBasic::HS)
    .def("T1",   (double (RBasic::*)(int) const) &RBasic::T1)
    .def("T2",   (double (RBasic::*)(int) const) &RBasic::T2)
    .def("R1",   (double (RBasic::*)(int) const) &RBasic::R1)
    .def("R2",   (double (RBasic::*)(int) const) &RBasic::R2)
    .def("LW",   (double (RBasic::*)(int) const) &RBasic::LW)
    .def("RB",   (double (RBasic::*)(int, int) const) &RBasic::RB)

    .def("T1",   (void (RBasic::*)(double, int)) &RBasic::T1)
    .def("T2",   (void (RBasic::*)(double, int)) &RBasic::T2)
    .def("R1",   (void (RBasic::*)(double, int)) &RBasic::R1)
    .def("R2",   (void (RBasic::*)(double, int)) &RBasic::R2)
    .def("LW",   (void (RBasic::*)(double, int)) &RBasic::LW)
    .def("RB",   (void (RBasic::*)(double, int, int)) &RBasic::RB)
    ...
    .def("R2s",     &RBasic::R2s)
    .def("LWs",     &RBasic::LWs)
    .def("RBRates", &RBasic::RBRates)

    .def("SetSystem", &RBasic::SetSystem, RBasic_SetSystem())
    .def("SetH0",     &RBasic::SetH0,     RBasic_SetH0())
    .def("SetDet",    &RBasic::SetDet,    RBasic_SetDet())
    .def("SetSigInf", &RBasic::SetSigInf, RBasic_SetSigInf())
    .def("R2Mx",      &RBasic::R2Mx)
    .def("R2LOp",     &RBasic::R2LOp)
    .def("R1LOp",     &RBasic::R1LOp)

    .def("SigmaT1",     &RBasic::SigmaT1)
    .def("SigmaT2",     &RBasic::SigmaT2)
    .def("SigmaC",      &RBasic::SigmaC)
//    .def("SigmaCEq",    &RBasic::SigmaCEq, RBasic_SigmaCEq())
    .def("RC",          &RBasic::RC)
//    .def("HC",          &RBasic::HC,      RBasic_HC())
    .def("Sigma",       &RBasic::Sigma)
...
*/
    .def("Evolve", (gen_op (RBasic::*)(const spin_sys&, const gen_op&, double)) &RBasic::Evolve)
    .def("Evolve", (gen_op (RBasic::*)(                 const gen_op&, double)) &RBasic::Evolve)

//  .def("FID", (void       (RBasic::*)(const spin_sys&, const gen_op&, double, row_vector&, int)) &RBasic::Evolve)
//  .def("FID", (void       (RBasic::*)(                 const gen_op&, double, row_vector&, int)) &RBasic::Evolve)
    .def("FID", (row_vector (RBasic::*)(const spin_sys&, const gen_op&, double,              int)) &RBasic::FID)
    .def("FID", (row_vector (RBasic::*)(                 const gen_op&, double,              int)) &RBasic::FID)

    .def(str(self))
//  .def("FzCoeffs", &RBasic::FzCoeffs)
  ;
  }
