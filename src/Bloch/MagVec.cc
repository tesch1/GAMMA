...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(MagVec_x,     MagVec::x,     0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(MagVec_y,     MagVec::y,     0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(MagVec_z,     MagVec::z,     0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(MagVec_norm,  MagVec::norm,  0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(MagVec_theta, MagVec::theta, 0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(MagVec_phi,   MagVec::phi,   0, 1)

BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(MagVec_write, MagVec::write, 1, 3)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(MagVec_read,  MagVec::read,  1, 3)

void PyMagVec()
  {
//                                  The Class

  class_<MagVec, bases<col_vector> >("MagVec")

//                                Constructors

    .def(init<optional<int> >())
    .def(init<const col_vector&>())
    .def(init<const MagVec&>())
...
//                              Member Functions
    ...
    .def("NComps", &MagVec::NComps)

    .def("Mx", (double (MagVec::*)(int) const) &MagVec::Mx)
    .def("My", (double (MagVec::*)(int) const) &MagVec::My)
    .def("Mz", (double (MagVec::*)(int) const) &MagVec::Mz)

    .def("Mx", (void   (MagVec::*)(int, double)) &MagVec::Mx)
    .def("My", (void   (MagVec::*)(int, double)) &MagVec::My)
    .def("Mz", (void   (MagVec::*)(int, double)) &MagVec::Mz)

    .def("x", (double (MagVec::*)(int) const)   &MagVec::x, MagVec_x())
    .def("y", (double (MagVec::*)(int) const)   &MagVec::y, MagVec_y())
    .def("z", (double (MagVec::*)(int) const)   &MagVec::z, MagVec_z())

    .def("norm",  (double (MagVec::*)(int) const) &MagVec::norm,  MagVec_norm())
    .def("theta", (double (MagVec::*)(int) const) &MagVec::theta, MagVec_theta())
    .def("phi",   (double (MagVec::*)(int) const) &MagVec::phi,   MagVec_phi())

//  .def("Norms", (std::vector<double> (MagVec::*)(int) const)           &MagVec::Norms)
//  .def("Norms", (void                (MagVec::*)(std::vector<double>)) &MagVec::Norms)

    .def("Norm",  (double (MagVec::*)(int) const)   &MagVec::Norm)
    .def("Norm",  (void   (MagVec::*)(double, int)) &MagVec::Norm)

    .def("write", (bool(MagVec::*) (const std::string&,  int, bool))0, MagVec_write())
    .def("read",  (bool(MagVec::*) (const std::string&,  int, bool))0, MagVec_read())

    .def("Mx", (MagVec (MagVec::*)() const) &MagVec::Mx)
    .def("My", (MagVec (MagVec::*)() const) &MagVec::My)
    .def("Mz", (MagVec (MagVec::*)() const) &MagVec::Mz)
...
//    .def("MxVec", (MagVec (MagVec::*)(int)) &MagVec::MxVec)
//    .def("MyVec", (MagVec (MagVec::*)(int)) &MagVec::MyVec)
//    .def("MzVec", (MagVec (MagVec::*)(int)) &MagVec::MzVec)

    .def("MxVec", (MagVec (MagVec::*)() const) &MagVec::MxVec)
    .def("MyVec", (MagVec (MagVec::*)() const) &MagVec::MyVec)
    .def("MzVec", (MagVec (MagVec::*)() const) &MagVec::MzVec)

    .def(str(self)) 

//                          Python Specialty Functions

    .def("__str__",     &MagVec::PyPrint)
  ;

//                  Static Methods ==> Global Functions
//  (See above, Delete when Boost.Python handles static methods)

//  def("MagVec_MxVec", (MagVec (MagVec::*)(int)) &MagVec::MxVec);
//  def("MagVec_MyVec", (MagVec (MagVec::*)(int)) &MagVec::MyVec);
//  def("MagVec_MzVec", (MagVec (MagVec::*)(int)) &MagVec::MzVec);
