...
**                              G A M M A				**
**									**
**      PyGAMMA Bloch Module Interface                Interface		**
**									**
**      Copyright (c) 2002						**
**      Scott Smith							**
...
** when the GAMMA Bloch module is built into a Python module without	**
...
#include <Bloch/BlochIF.h>			// All of Bloch module
...
// ____________________________________________________________________________
  ...
  PyBlochSys();					// Bloch spin systems
  PyMagVec();					// Bloch magnetization vectors
  PyBlochMx();					// Bloch matrices
  PyDetVec();					// Bloch detection vectors
  PyBlochR();					// Bloch relaxation matrices
  PyBlochB();					// Bloch rf-field matrices
  PyBlochK();					// Bloch exchange matrices
  PyBlochTraj();				// Bloch trajactories
  }
