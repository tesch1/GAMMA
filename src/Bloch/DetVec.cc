...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(DetVec_x,     DetVec::x,     0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(DetVec_y,     DetVec::y,     0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(DetVec_z,     DetVec::z,     0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(DetVec_norm,  DetVec::norm,  0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(DetVec_theta, DetVec::theta, 0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(DetVec_phi,   DetVec::phi,   0, 1)

BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(DetVec_write, DetVec::write, 1, 3)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(DetVec_read,  DetVec::read,  1, 3)

void PyDetVec()
  {
//                                  The Class

  class_<DetVec, bases<row_vector> >("DetVec")

//                                Constructors

    .def(init<optional<int> >())
    .def(init<const row_vector&>())
    .def(init<const DetVec&>())
    .def(init<double, double, double>())
    .def(init<const coord&>())
    .def(init<double, double, double, double, double, double>())
    .def(init<const coord&, const coord&>())
    .def(init<const std::vector<coord>&>())
    .def(init<int, char >())

//                              Member Functions

    .def("NComps", &DetVec::NComps)

    .def("Dx", (double (DetVec::*)(int) const) &DetVec::Dx)
    .def("Dy", (double (DetVec::*)(int) const) &DetVec::Dy)
    .def("Dz", (double (DetVec::*)(int) const) &DetVec::Dz)

    .def("Dx", (void   (DetVec::*)(int, double)) &DetVec::Dx)
    .def("Dy", (void   (DetVec::*)(int, double)) &DetVec::Dy)
    .def("Dz", (void   (DetVec::*)(int, double)) &DetVec::Dz)

    .def("x", (double (DetVec::*)(int) const)   &DetVec::x, DetVec_x())
    .def("y", (double (DetVec::*)(int) const)   &DetVec::y, DetVec_y())
    .def("z", (double (DetVec::*)(int) const)   &DetVec::z, DetVec_z())

    .def("norm",  (double (DetVec::*)(int) const) &DetVec::norm,  DetVec_norm())
    .def("theta", (double (DetVec::*)(int) const) &DetVec::theta, DetVec_theta())
    .def("phi",   (double (DetVec::*)(int) const) &DetVec::phi,   DetVec_phi())

//  .def("Norms", (std::vector<double> (DetVec::*)(int) const)           &DetVec::Norms)
//  .def("Norms", (void                (DetVec::*)(std::vector<double>)) &DetVec::Norms)

    .def("Norm",  (double (DetVec::*)(int) const)   &DetVec::Norm)
    .def("Norm",  (void   (DetVec::*)(double, int)) &DetVec::Norm)

// Parameter Set Functions Are Not Exported Yet

    .def("write", (bool(DetVec::*) (const std::string&,  int, bool))0, DetVec_write())
    .def("read",  (bool(DetVec::*) (const std::string&,  int, bool))0, DetVec_read())

    .def(str(self)) 

    .def("Dx", (DetVec (DetVec::*)() const) &DetVec::Dx)
    .def("Dy", (DetVec (DetVec::*)() const) &DetVec::Dy)
    .def("Dz", (DetVec (DetVec::*)() const) &DetVec::Dz)
...
//    .def("DxVec", (DetVec (DetVec::*)(int)) &DetVec::DxVec)
//    .def("DyVec", (DetVec (DetVec::*)(int)) &DetVec::DyVec)
//    .def("DzVec", (DetVec (DetVec::*)(int)) &DetVec::DzVec)

    .def("DxVec", (DetVec (DetVec::*)() const) &DetVec::DxVec)
    .def("DyVec", (DetVec (DetVec::*)() const) &DetVec::DyVec)
    .def("DzVec", (DetVec (DetVec::*)() const) &DetVec::DzVec)

//                          Python Specialty Functions

    .def("__str__",     &DetVec::PyPrint)
  ;

//                  Static Methods ==> Global Functions
//  (See above, Delete when Boost.Python handles static methods)

//  def("DetVec_DxVec", (DetVec (DetVec::*)(int)) &DetVec::DxVec);
//  def("DetVec_DyVec", (DetVec (DetVec::*)(int)) &DetVec::DyVec);
//  def("DetVec_DzVec", (DetVec (DetVec::*)(int)) &DetVec::DzVec);
