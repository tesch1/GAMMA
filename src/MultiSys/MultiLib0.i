...
gen_op multize(gen_op op(const spin_sys&,const gen_op&,const std::string&, double), gen_op&, const std::string&, double, const multi_sys&, int icomp=-1);
