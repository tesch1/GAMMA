...
**                              G A M M A				**
**									**
**      PyGAMMA Multisys Module Python Interface          Interface	**
**									**
**      Copyright (c) 2002						**
**      Scott Smith							**
...
#ifndef _PyMultiSys_h_			// Is this file already included?
#define _PyMultiSys_h_ 1			// If no, then remember it
