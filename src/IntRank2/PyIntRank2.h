...
**                              G A M M A				**
**									**
**      PyGAMMA Rank 2 Interactions Python Interface       Interface	**
**									**
**      Copyright (c) 2002						**
**      Scott Smith							**
...
#ifndef _PyIntRank2_h_			// Is this file already included?
#define _PyIntRank2_h_ 1			// If no, then remember it
